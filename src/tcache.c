...
unsigned opt_tcache_nslots_small_min = TCACHE_NSLOTS_SMALL_MIN;
unsigned opt_tcache_nslots_small_max = TCACHE_NSLOTS_SMALL_MAX;
unsigned opt_tcache_nslots_large = TCACHE_NSLOTS_LARGE;
